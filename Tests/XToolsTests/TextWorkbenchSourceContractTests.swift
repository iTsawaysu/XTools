...
struct TextWorkbenchSourceContractTests {
    ...
    @Test func structuredFormatterTopControlsStayInPlace() throws {
        ...
        doesNotContain(json, "IndexOptionSwitch(", "JSON must not keep the retired key-sort switch")
        ...
        contains(sql, "IndexOptionLabel(\"关键字\")", "SQL formatter must label its keyword-case parameter in the workbench toolbar")
        contains(sql, "IndexSegmentedControl(\n                        items: [(\"upper\", \"大写\"), (\"lower\", \"小写\")]", "SQL keyword-case must use the toolbar segmented control")
