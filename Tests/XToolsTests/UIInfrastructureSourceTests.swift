...
struct UIInfrastructureSourceTests {
    ...
    @Test func sidebarNavigationUsesOneStableAppKitRenderer() throws {
        ...
        contains(renderer, "positioned: .below, relativeTo: nil", "The indicator must stay below every track through reorder cycles")
        doesNotContain(toolRow, "selectionFill", "Tool rows must not repaint selection chrome the sliding indicator owns")
