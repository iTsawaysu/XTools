...
extension Theme {
  ...
  public func heading1<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ configuration: BlockConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func heading2<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ label: BlockConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func codeBlock<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ configuration: CodeBlockConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func taskListMarker<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ configuration: TaskListMarkerConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func bulletedListMarker<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ configuration: ListMarkerConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func tableCell<Body: View>(
    @ViewBuilder body: @escaping @MainActor (_ configuration: TableCellConfiguration) -> Body
  ) -> Theme {
    var theme = self
  ...
  public func thematicBreak<Body: View>(@ViewBuilder body: @escaping @MainActor () -> Body) -> Theme {
    var theme = self
